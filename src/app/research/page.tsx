      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 space-y-10">
        {areas.map((area, i) => {
          ...
          return (
            ...
            >
              <div
                className="text-5xl font-serif font-medium tabular-nums"
                style={{ color: accentVar, opacity: 0.4 }}
              >
                {String(i + 1).padStart(2, '0')}
              </div>
              <div>
                <h2 className="text-2xl font-serif font-medium mb-3" style={{ color: 'var(--text-primary)' }}>
